...
##PC##
data=read_excel("/Users/jbrown/Documents/GitHub/Lipid_Quantification/Data/Extraction Samples JLM.xlsx",sheet = "2017JUL")
...
#data=read_excel("/Users/JamesB/Google Drive/Graduate School/Self_JamesTBrown/GitHub/Lipid_Quantification/Data/Extraction Samples JLM.xlsx", sheet = "2017JUL")
...
ggplot(data2,aes(x=strain,y=stdresd, color=photoperiod))+
  geom_boxplot()+
  theme_classic()+
  ggtitle("July Cohort: Within Strain Effect")+
  ylab("Lipid Mass")
...
ggplot(data2,aes(x=strain,y=stdresd, color=strain))+
  geom_boxplot()+
  theme_classic()+
  ggtitle("July Cohort: Pooled Effect of Strain")+ylab("Lipid Mass")

ggplot(data2,aes(x=photoperiod,y=stdresd, color=photoperiod))+
  geom_boxplot()+
  theme_classic()+
  ggtitle("July Cohort: Pooled Effect of Photoperiod")+ylab("Lipid Mass")

##Photoperiod effect by std residuals of lipid mass
ggplot(data2,aes(x=photoperiod,y=stdresd,color=strain))+
  geom_boxplot()+
  theme_classic()+
  ggtitle("July Cohort: Between Strain Effect")+ylab("Lipid Mass")
...
ggplot(data2,aes(x=treat,y=measurement,color=traits))+
  theme_classic()+
  geom_boxplot()+
  ggtitle("July Trait Measurements")+
  ylab("Lipid Mass")
```