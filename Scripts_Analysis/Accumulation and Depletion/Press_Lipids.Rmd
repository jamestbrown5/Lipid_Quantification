...
datal=subset(datal,lean_mass<=0.0200)
count(datal$treat)
...
ggplot(data=dataLipid,aes(x=sample_day,y=lipid_mass,group=photoperiod,color=photoperiod))+
...
mixedL1=lmer(lipid_mass ~ photoperiod*strain + lean_mass + (1|rep) ,data=dataL1, REML = TRUE)
summary(mixedL1)
plot(mixedL1)
##The following model removes photoperiod as factors to determine the effect of lipid mass and Rep on lipid mass
submodL1=lmer(lipid_mass ~ (1|rep),data=dataL1, REML = TRUE)
summary(submodL1)
...
ggplot(data=dataL1,aes(x=sample_day,y=lipid_mass,color=photoperiod))+
...
mixedLW=lmer(lipid_mass ~ photoperiod*strain + lean_mass + (1|rep) ,data=dataLW, REML = TRUE)
summary(mixedLW)
plot(mixedLW)
##The following model removes photoperiod as factors to determine the effect of lipid mass and Rep on lipid mass
submodLW=lmer(lipid_mass ~ (1|rep),data=dataLW, REML = TRUE)
summary(submodLW)
...
ggplot(data=dataWeD,aes(x=sample_day,y=lipid_mass,group=treat,color=treat))+
...
mixedWeD1=lmer(lipid_mass ~  strain*photoperiod + (1|rep),data=dataWeD1, REML = TRUE)
summary(mixedWeD1)
plot(mixedWeD1)
##The following model removes photoperiod as factors to determine the effect of lipid mass and Rep on lipid mass
submodLeD1=lmer(lipid_mass ~ (1|rep),data=dataWeD1, REML = TRUE)
summary(submodLeD1)
...
#this model attempts to fit the linear mixed effects model with 3 variables; photoperiod, lipid mass, and the random effect of rep
## Strain does SIGNIFICANTLY effect lipid mass accumulation between larvae reared in long day vs short day conditions
mixedWeDW=lmer(lipid_mass ~  strain + (1|rep),data=dataWeDW, REML = TRUE)
summary(mixedWeDW)
plot(mixedWeDW)
##The following model removes photoperiod as factors to determine the effect of lipid mass and Rep on lipid mass
submodLeDW=lmer(lipid_mass ~ (1|rep),data=dataWeDW, REML = TRUE)
summary(submodLeDW)
...
#this model attempts to fit the linear mixed effects model with 3 variables; photoperiod, lipid mass, and the random effect of rep
## Photoperiod does SIGNIFICANTLY effect lipid mass accumulation between larvae reared in long day vs short day conditions
mixedWeDW15=lmer(lipid_mass ~ strain*photoperiod + (1|rep) ,data=dataWeDW15, REML = TRUE)
summary(mixedWeDW15)
plot(mixedWeDW15)
##The following model removes photoperiod as factors to determine the effect of lipid mass and Rep on lipid mass
submodLeDW15=lmer(lipid_mass ~ (1|rep),data=dataWeDW15, REML = TRUE)
...
#this model attempts to fit the linear mixed effects model with 3 variables; photoperiod, lipid mass, and the random effect of rep
## Photoperiod does SIGNIFICANTLY effect lipid mass accumulation between larvae reared in long day vs short day conditions
mixedWeDW20=lmer(lipid_mass ~ strain*photoperiod + (1|rep) ,data=dataWeDW20, REML = TRUE)
summary(mixedWeDW20)
plot(mixedWeDW20)
##The following model removes photoperiod as factors to determine the effect of lipid mass and Rep on lipid mass
submodLeDW20=lmer(lipid_mass ~ (1|rep),data=dataWeDW20, REML = TRUE)
...
#this model attempts to fit the linear mixed effects model with 3 variables; photoperiod, lipid mass, and the random effect of rep
## Photoperiod does SIGNIFICANTLY effect lipid mass accumulation between larvae reared in long day vs short day conditions
mixedWeDW30=lmer(lipid_mass ~ strain*photoperiod + (1|rep) ,data=dataWeDW30, REML = TRUE)
summary(mixedWeDW30)
plot(mixedWeDW30)
##The following model removes photoperiod as factors to determine the effect of lipid mass and Rep on lipid mass
submodLeDW30=lmer(lipid_mass ~ (1|rep),data=dataWeDW30, REML = TRUE)
...
#this model attempts to fit the linear mixed effects model with 3 variables; photoperiod, lipid mass, and the random effect of rep
## Strain does SIGNIFICANTLY effect lipid mass accumulation between larvae reared in long day vs short day conditions
mixedWeND1=lmer(lipid_mass ~  strain + (1|rep),data=dataWeND1, REML = TRUE)
summary(mixedWeND1)
plot(mixedWeND1)
##The following model removes photoperiod as factors to determine the effect of lipid mass and Rep on lipid mass
submodLeND1=lmer(lipid_mass ~ (1|rep),data=dataWeND1, REML = TRUE)
summary(submodLeND1)
...
#this model attempts to fit the linear mixed effects model with 3 variables; photoperiod, lipid mass, and the random effect of rep
## Strain does SIGNIFICANTLY effect lipid mass accumulation between larvae reared in long day vs short day conditions
mixedWeNDW=lmer(lipid_mass ~  strain + (1|rep),data=dataWeNDW, REML = TRUE)
summary(mixedWeNDW)
plot(mixedWeNDW)
##The following model removes photoperiod as factors to determine the effect of lipid mass and Rep on lipid mass
submodLeNDW=lmer(lipid_mass ~ (1|rep),data=dataWeNDW, REML = TRUE)
summary(submodLeNDW)
...
#this model attempts to fit the linear mixed effects model with 3 variables; photoperiod, lipid mass, and the random effect of rep
## Strain does SIGNIFICANTLY effect lipid mass accumulation between larvae reared in long day vs short day conditions
mixedWeBED1=lmer(lipid_mass ~  treat + (1|rep),data=dataWeBED1, REML = TRUE)
summary(mixedWeBED1)
plot(mixedWeBED1)
##The following model removes photoperiod as factors to determine the effect of lipid mass and Rep on lipid mass
submodLeBED1=lmer(lipid_mass ~ (1|rep),data=dataWeBED1, REML = TRUE)
...
#this model attempts to fit the linear mixed effects model with 3 variables; photoperiod, lipid mass, and the random effect of rep
## Strain does SIGNIFICANTLY effect lipid mass accumulation between larvae reared in long day vs short day conditions
mixedWeBEDW=lmer(lipid_mass ~  treat + (1|rep),data=dataWeBEDW, REML = TRUE)
summary(mixedWeBEDW)
plot(mixedWeBEDW)
##The following model removes photoperiod as factors to determine the effect of lipid mass and Rep on lipid mass
submodLeBEDW=lmer(lipid_mass ~ (1|rep),data=dataWeBEDW, REML = TRUE)
...
#this model attempts to fit the linear mixed effects model with 3 variables; photoperiod, lipid mass, and the random effect of rep
## Strain does SIGNIFICANTLY effect lipid mass accumulation between larvae reared in long day vs short day conditions
mixedWeUZD1=lmer(lipid_mass ~  treat + (1|rep),data=dataWeUZD1, REML = TRUE)
summary(mixedWeUZD1)
plot(mixedWeUZD1)
##The following model removes photoperiod as factors to determine the effect of lipid mass and Rep on lipid mass
submodLeUZD1=lmer(lipid_mass ~ (1|rep),data=dataWeUZD1, REML = TRUE)
...
#this model attempts to fit the linear mixed effects model with 3 variables; photoperiod, lipid mass, and the random effect of rep
## Strain does SIGNIFICANTLY effect lipid mass accumulation between larvae reared in long day vs short day conditions
mixedWeUZDW=lmer(lipid_mass ~  treat + (1|rep),data=dataWeUZDW, REML = TRUE)
summary(mixedWeUZDW)
plot(mixedWeUZDW)
##The following model removes photoperiod as factors to determine the effect of lipid mass and Rep on lipid mass
submodLeUZDW=lmer(lipid_mass ~ (1|rep),data=dataWeUZDW, REML = TRUE)
