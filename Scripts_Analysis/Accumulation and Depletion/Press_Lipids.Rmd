...
mixedL1=lmer(lipid_mass ~ photoperiod + (1|rep) ,data=dataL1, REML = TRUE)
summary(mixedL1)
plot(mixedL1)
...
mixedLW=lmer(lipid_mass ~ photoperiod + (1|rep) ,data=dataLW, REML = TRUE)
summary(mixedLW)
plot(mixedLW)
##The following model removes photoperiod as factors to determine the effect of lipid mass and Rep on lipid mass
...
mixedWeD1=lmer(lipid_mass ~  strain + (1|rep),data=dataWeD1, REML = TRUE)
summary(mixedWeD1)
plot(mixedWeD1)
##The following model removes photoperiod as factors to determine the effect of lipid mass and Rep on lipid mass
...
#this model attempts to fit the linear mixed effects model with 3 variables; photoperiod, lipid mass, and the random effect of rep
## Photoperiod does SIGNIFICANTLY effect lipid mass accumulation between larvae reared in long day vs short day conditions
mixedWeDW15=lmer(lipid_mass ~ strain + (1|rep) ,data=dataWeDW15, REML = TRUE)
summary(mixedWeDW15)
plot(mixedWeDW15)
##The following model removes photoperiod as factors to determine the effect of lipid mass and Rep on lipid mass
...
#this model attempts to fit the linear mixed effects model with 3 variables; photoperiod, lipid mass, and the random effect of rep
## Photoperiod does SIGNIFICANTLY effect lipid mass accumulation between larvae reared in long day vs short day conditions
mixedWeDW20=lmer(lipid_mass ~ strain + (1|rep) ,data=dataWeDW20, REML = TRUE)
summary(mixedWeDW20)
plot(mixedWeDW20)
##The following model removes photoperiod as factors to determine the effect of lipid mass and Rep on lipid mass
...
#this model attempts to fit the linear mixed effects model with 3 variables; photoperiod, lipid mass, and the random effect of rep
## Photoperiod does SIGNIFICANTLY effect lipid mass accumulation between larvae reared in long day vs short day conditions
mixedWeDW30=lmer(lipid_mass ~ strain + (1|rep) ,data=dataWeDW30, REML = TRUE)
summary(mixedWeDW30)
plot(mixedWeDW30)
##The following model removes photoperiod as factors to determine the effect of lipid mass and Rep on lipid mass
