...
mixedUB=lmer(lean_mass ~ strain*photoperiod + (1|rep) ,data=dataUB, REML = TRUE)
summary(mixedUB)
plot(mixedUB)
##The following model removes photoperiod as factors to determine the effect of lean mass and Rep on lean mass
submodUB=lmer(lean_mass ~ (1|rep),data=dataUB, REML = TRUE)
summary(submodUB)
...
mixedL1=lmer(lean_mass ~ strain*photoperiod + (1|rep) ,data=dataL1, REML = TRUE)
summary(mixedL1)
plot(mixedL1)
##The following model removes photoperiod as factors to determine the effect of lean mass and Rep on lean mass
...
#this model attempts to fit the linear mixed effects model with 3 variables; photoperiod, lean mass, and the random effect of rep
## Photoperiod does SIGNIFICANTLY effect lean mass accumulation between larvae reared in long day vs short day conditions
mixedLW=lmer(lean_mass ~ strain*photoperiod + (1|rep) ,data=dataLW, REML = TRUE)
summary(mixedLW)
plot(mixedLW)
##The following model removes photoperiod as factors to determine the effect of lean mass and Rep on lean mass
...
mF=lm(lipid_mass~sample_day,data=dataLeDU)
summary(mF)
```
...
#this model attempts to fit the linear mixed effects model with 3 variables; photoperiod, lean mass, and the random effect of rep
## Strain does SIGNIFICANTLY effect lean mass accumulation between larvae reared in long day vs short day conditions
mixedLeBED1=lmer(lean_mass ~  treat + (1|rep),data=dataLeBED1, REML = TRUE)
summary(mixedLeBED1)
plot(mixedLeBED1)
##The following model removes photoperiod as factors to determine the effect of lean mass and Rep on lean mass
submodLeBED1=lmer(lean_mass ~ (1|rep),data=dataLeBED1, REML = TRUE)
...
#this model attempts to fit the linear mixed effects model with 3 variables; photoperiod, lean mass, and the random effect of rep
## Strain does SIGNIFICANTLY effect lean mass accumulation between larvae reared in long day vs short day conditions
mixedLeBEDW=lmer(lean_mass ~  treat + (1|rep),data=dataLeBEDW, REML = TRUE)
summary(mixedLeBEDW)
plot(mixedLeBEDW)
##The following model removes photoperiod as factors to determine the effect of lean mass and Rep on lean mass
submodLeBEDW=lmer(lean_mass ~ (1|rep),data=dataLeBEDW, REML = TRUE)
...
#this model attempts to fit the linear mixed effects model with 3 variables; photoperiod, lean mass, and the random effect of rep
## Strain does SIGNIFICANTLY effect lean mass accumulation between larvae reared in long day vs short day conditions
mixedLeUZD1=lmer(lean_mass ~  treat + (1|rep),data=dataLeUZD1, REML = TRUE)
summary(mixedLeUZD1)
plot(mixedLeUZD1)
##The following model removes photoperiod as factors to determine the effect of lean mass and Rep on lean mass
submodLeUZD1=lmer(lean_mass ~ (1|rep),data=dataLeUZD1, REML = TRUE)
...
#this model attempts to fit the linear mixed effects model with 3 variables; photoperiod, lean mass, and the random effect of rep
## Strain does SIGNIFICANTLY effect lean mass accumulation between larvae reared in long day vs short day conditions
mixedLeUZDW=lmer(lean_mass ~  treat + (1|rep),data=dataLeUZDW, REML = TRUE)
summary(mixedLeUZDW)
plot(mixedLeUZDW)
##The following model removes photoperiod as factors to determine the effect of lean mass and Rep on lean mass
submodLeUZDW=lmer(lean_mass ~ (1|rep),data=dataLeUZDW, REML = TRUE)
